...
import {
  IDeleteUserInputDTO,
  IEditInputDTO,
  IGetUseResponseOutputDTO,
  IGetUsersDBDTO,
  IGetUsersInputDTO,
  IGetUsersUserResponseOutoutDTO,
  ILoginInputDTO,
  ISingupInputDTO,
  ISingupOutputDTO,
  User,
...
export class UserBusiness {
  ...
  public signup = async (input: ISingupInputDTO) => {
    ...
    const response: ISingupOutputDTO = {
  ...
  public getUsers = async (input: IGetUsersInputDTO) => {
    ...
    const users = usersDB.map((userDB) => {
      ...
      const userResponse: IGetUsersUserResponseOutoutDTO = {
        id: user.getId(),
        name: user.getName(),
        email: user.getEmail(),
      };
    ...
    const response: IGetUseResponseOutputDTO = {
      users,
    };
  ...
  public editUser = async (input: IEditInputDTO) => {
